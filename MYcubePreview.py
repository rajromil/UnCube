"""
Cube Preview Module for Rubik's Cube Solver
Author: ROMIL RAJ
Description: Visual cube state preview with 3D representation
"""
...
def default(blank):
    ...
    # Add title for the cube preview
    cv.putText(blank, 'CUBE PREVIEW', (220, 25), cv.FONT_HERSHEY_SIMPLEX, 1.0, (255, 255, 255), 2)
    cv.line(blank, (220, 30), (380, 30), (255, 255, 255), 2)

    # Face labels with better fonts and positioning
    cv.putText(blank, 'UPPER', (30, 40), cv.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 255), 2)
    cv.putText(blank, 'FRONT', (30, 340), cv.FONT_HERSHEY_SIMPLEX, 0.8, (255, 0, 0), 2)
    cv.putText(blank, 'RIGHT', (30, 630), cv.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)
    cv.putText(blank, 'DOWN', (330, 40), cv.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 255), 2)
    cv.putText(blank, 'BACK', (330, 340), cv.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
    cv.putText(blank, 'LEFT', (330, 630), cv.FONT_HERSHEY_SIMPLEX, 0.8, (0, 140, 255), 2)
    ...
    # Add center dot for upper face
    cv.circle(blank, (150, 170), 8, (0, 0, 0), -1)
    cv.circle(blank, (150, 170), 6, (0, 0, 0), -1)
    ...
    # Add center dot for front face
    cv.circle(blank, (150, 470), 8, (0, 0, 0), -1)
    cv.circle(blank, (150, 470), 6, (0, 0, 0), -1)
    ...
    # Add center dot for right face
    cv.circle(blank, (150, 760), 8, (0, 0, 0), -1)
    cv.circle(blank, (150, 760), 6, (0, 0, 0), -1)
    ...
    # Add center dot for down face
    cv.circle(blank, (450, 170), 8, (0, 0, 0), -1)
    cv.circle(blank, (450, 170), 6, (0, 0, 0), -1)
    ...
    # Add center dot for back face
    cv.circle(blank, (450, 470), 8, (0, 0, 0), -1)
    cv.circle(blank, (450, 470), 6, (0, 0, 0), -1)
    ...
    # Add center dot for left face
    cv.circle(blank, (450, 760), 8, (0, 0, 0), -1)
    cv.circle(blank, (450, 760), 6, (0, 0, 0), -1)
